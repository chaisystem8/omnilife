            ...
            <div>
                <form id="upload-form" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="salarioP" id="salarioP" step="0.01" value="{{old('salarioP')}}" required>
                        ...
                        <input class="form-control" type="number" name="salarioD" id="salarioD" step="0.01" value="{{old('salarioD')}}" readonly required>

                        <label for="estado">Estado</label>
                        <select id="estadosSelect" class="form-control" name="estado" value="{{old('estado')}}" required>
                            <option value="">Selecciona un estado</option>
                        </select>
                        <label for="ciudad">Ciudad</label>
                        <select id="municipiosSelect" class="form-control" name="ciudad" value="{{old('ciudad')}}" required>
                            <option value="">Selecciona un municipio</option>
                        </select>
                        <label for="direccion">Dirección</label>
                        <input class="form-control" type="text" name="direccion" id="direccion" value="{{old('direccion')}}" required>
                        <label for="celular">Celular</label>
                        <input class="form-control" type="text" name="celular" id="celular" value="{{old('celular')}}" required>
                    ...
                    <div class="d-flex justify-content-center pt-3">
                        <input id="btnSave" type="submit" value="Guardar Empleado" class="btn btn-primary">
                    </div>
                </form>
            </div>
        </div>
